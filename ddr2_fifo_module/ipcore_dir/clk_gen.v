...
//  /   /         Filename : clk_gen.v
// /___/   /\     Timestamp : 05/27/2013 16:31:07
// \   \  /  \ 
//  \___\/\___\ 
//
//Command: xaw2verilog -st D:\ddr2_xilinx_v5\ddr2_fifo_module\ipcore_dir\.\clk_gen.xaw D:\ddr2_xilinx_v5\ddr2_fifo_module\ipcore_dir\.\clk_gen
//Design Name: clk_gen
...
// For block PLL_ADV_INST, Estimated PLL Jitter for CLKOUT1 = 0.196 ns
// For block PLL_ADV_INST, Estimated PLL Jitter for CLKOUT2 = 0.181 ns
// For block PLL_ADV_INST, Estimated PLL Jitter for CLKOUT3 = 0.172 ns
`timescale 1ns / 1ps
...
module clk_gen(CLKIN1_IN, 
   ...
   PLL_ADV #( .BANDWIDTH("OPTIMIZED"), .CLKIN1_PERIOD(20.000), 
         ...
         .CLKFBOUT_MULT(12), .CLKFBOUT_PHASE(0.0), .REF_JITTER(0.005000) ) 
